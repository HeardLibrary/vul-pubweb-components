            ...
            <div class="container">
                <div class="vu-navbar-header">
                    ...
                    <a class="vu-navbar-brand" href="http://www.vanderbilt.edu">
                        <img class="hidden-xs hidden-sm hidden-md" src="${lockup}" alt="Vanderbilt University">
                        <img class="visible-xs visible-sm visible-md" src="${lockup}" alt="Vanderbilt University">
                    </a>
                </div>
                <div class="vubrandbar collapse vu-navbar-collapse">
                    <ul class="vu-nav vu-navbar-nav vu-navbar-right vu-toolbar">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="http://vu.edu/directory">PeopleFinder</a></li>
